...
import ProductsList from './apps/admin/pages/ProductsList'
import ProductEditor from './apps/admin/pages/ProductEditor'
import CollectionsList from './apps/admin/pages/CollectionsList'
import CollectionEditor from './apps/admin/pages/CollectionEditor'
import OrdersList from './apps/admin/pages/OrdersList'
import CustomerDetail from './apps/admin/pages/CustomerDetail'
import HomeBuilder from './apps/admin/pages/HomeBuilder'
import SitePageEditor from './apps/admin/pages/SitePageEditor'
import MediaLibrary from './apps/admin/pages/MediaLibrary'
import StoriesList from './apps/admin/pages/StoriesList'
import StoryEditor from './apps/admin/pages/StoryEditor'
import StoryReviewQueue from './apps/admin/pages/StoryReviewQueue'
import MembersList from './apps/admin/pages/MembersList'
import MemberProfile from './apps/admin/pages/MemberProfile'
import ContributionsList from './apps/admin/pages/ContributionsList'
import ContributionDetail from './apps/admin/pages/ContributionDetail'
import ChallengesList from './apps/admin/pages/ChallengesList'
import ChallengeEditor from './apps/admin/pages/ChallengeEditor'
import ChallengeSubmissions from './apps/admin/pages/ChallengeSubmissions'
import ChallengeResults from './apps/admin/pages/ChallengeResults'
import LabProjectsList from './apps/admin/pages/LabProjectsList'
import LabProjectEditor from './apps/admin/pages/LabProjectEditor'
import CallsForContribution from './apps/admin/pages/CallsForContribution'
import CommerceAnalytics from './apps/admin/pages/CommerceAnalytics'
import CommunityAnalytics from './apps/admin/pages/CommunityAnalytics'
import ContentAnalytics from './apps/admin/pages/ContentAnalytics'
import TeamRoles from './apps/admin/pages/TeamRoles'
import GlobalSettings from './apps/admin/pages/GlobalSettings'
import AuditLog from './apps/admin/pages/AuditLog'
import Components from './apps/admin/pages/Components'
import StyleGuidesList from './apps/admin/pages/StyleGuidesList'
import StyleGuideEditor from './apps/admin/pages/StyleGuideEditor'
import RecommendationHubList from './apps/admin/pages/RecommendationHubList'
import RecommendationHubEditor from './apps/admin/pages/RecommendationHubEditor'
import ProductPassportList from './apps/admin/pages/ProductPassportList'
import ProductPassportEditor from './apps/admin/pages/ProductPassportEditor'
import ProductionCenter from './apps/admin/pages/ProductionCenter'
import ProductionTemplates from './apps/admin/pages/ProductionTemplates'
import ProductionAssets from './apps/admin/pages/ProductionAssets'
import PrintPresets from './apps/admin/pages/PrintPresets'
import BatchGenerator from './apps/admin/pages/BatchGenerator'
import ExportCenter from './apps/admin/pages/ExportCenter'
import LegacyArchives from './apps/admin/pages/LegacyArchives'
import LegacyTimeline from './apps/admin/pages/LegacyTimeline'
import LegacyKeeperCircle from './apps/admin/pages/LegacyKeeperCircle'
import LegacyVoting from './apps/admin/pages/LegacyVoting'
import LegacyRewards from './apps/admin/pages/LegacyRewards'
import LegacyAchievements from './apps/admin/pages/LegacyAchievements'
import LegacyInvitations from './apps/admin/pages/LegacyInvitations'
import LegacyReferral from './apps/admin/pages/LegacyReferral'
import LegacyAnalytics from './apps/admin/pages/LegacyAnalytics'
import Legacies from './apps/admin/pages/Legacies'
import HeritageLibrary from './apps/admin/pages/HeritageLibrary'
import BrandAssets from './apps/admin/pages/BrandAssets'
import QRExperiences from './apps/admin/pages/QRExperiences'
import QRCodeGenerator from './apps/admin/pages/QRCodeGenerator'
import LegacyKeeperLevels from './apps/admin/pages/LegacyKeeperLevels'
import SystemAutomation from './apps/admin/pages/SystemAutomation'
import ProductionAnalytics from './apps/admin/pages/ProductionAnalytics'
import RecommendationAnalytics from './apps/admin/pages/RecommendationAnalytics'
