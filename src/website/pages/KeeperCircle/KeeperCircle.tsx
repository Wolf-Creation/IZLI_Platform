  ...
  return (
    <div style={{ background: BG, fontFamily: FONT_SANS }}>
      ...
      <section style={{ background: BG, padding: '64px 0' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 32 }}>
          <div>
            <div>
              <h2 style={{ fontFamily: FONT_SERIF, fontSize: 22, fontWeight: 500, color: INDIGO, margin: '0 0 20px' }}>Your Archive Pieces</h2>
            ...
            <div style={{ marginTop: 32 }}>
              <h2 style={{ fontFamily: FONT_SERIF, fontSize: 22, fontWeight: 500, color: INDIGO, margin: '0 0 20px' }}>Cast Your Vote</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {voteCards.map((v) => (
                  <div key={v.id} style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 20 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
                      {v.options.map((opt) => (
                        <label key={opt} style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer' }}>
                          <input type="radio" name={`vote-${v.id}`} value={opt} checked={votes[v.id] === opt} onChange={() => setVotes((prev) => ({ ...prev, [v.id]: opt }))} style={{ accentColor: INDIGO, width: 16, height: 16 }} />
            ...
            <div style={{ marginTop: 32 }}>
              <h2 style={{ fontFamily: FONT_SERIF, fontSize: 22, fontWeight: 500, color: INDIGO, margin: '0 0 20px' }}>Keeper Stories</h2>
          ...
          <div>
            <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 20 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: INDIGO, marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Keeper Stats</div>
            ...
            <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 20, marginTop: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: INDIGO, marginBottom: 4, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Upcoming Archive</div>
