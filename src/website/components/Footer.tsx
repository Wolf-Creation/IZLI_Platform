...
export default function Footer({ onNavigate }: Props) {
  return (
    <footer style={{ background: INDIGO, paddingTop: 64, paddingBottom: 40 }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: 48, marginBottom: 56 }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 0 }}>
              ...
              />
              <button style={{ padding: '9px 16px', background: CREAM, border: 'none', borderRadius: '0 9px 9px 0', fontSize: 12, fontWeight: 600, color: INDIGO, cursor: 'pointer', fontFamily: FONT_SANS, whiteSpace: 'nowrap' }}>
                Subscribe
              </button>
            </div>
          </div>
          ...
          {LINKS.map(group => (
            <div key={group.group}>
              <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: SAND, marginBottom: 16 }}>{group.group}</div>
        ...
        {/* Divider */}
        <div style={{ height: 1, background: 'rgba(231,223,210,0.12)', marginBottom: 28 }} />
