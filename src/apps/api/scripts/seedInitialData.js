...
await replaceMany(Product, [
  { sku: 'IZL-HRT-TEE-001', name: 'Tifinagh Frame Tee', universe: 'Heritage', status: 'published', price: 89, currency: 'EUR', description: 'A heavyweight organic cotton tee with Tifinagh inspiration.', coverImageUrl: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=800&h=1000&fit=crop&auto=format', images: [], sizes: [], materials: [], careInstructions: [], relatedStoryId: null, relatedChallengeId: null, collectionIds: [], tags: [], createdAt: new Date().toISOString() },
  { sku: 'IZL-HRT-OVR-001', name: 'Woven Sahara Overshirt', universe: 'Heritage', status: 'published', price: 195, currency: 'EUR', description: 'Hand-loomed Saharan wool overshirt.', coverImageUrl: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&h=1000&fit=crop&auto=format', images: [], sizes: [], materials: [], careInstructions: [], relatedStoryId: null, relatedChallengeId: null, collectionIds: [], tags: [], createdAt: new Date().toISOString() },
  { sku: 'IZL-ESS-TEE-001', name: 'Atlas Symbol Boxy Tee', universe: 'Essentials', status: 'published', price: 65, currency: 'EUR', description: 'Oversized tee with Atlas symbol embroidery.', coverImageUrl: 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=800&h=1000&fit=crop&auto=format', images: [], sizes: [], materials: [], careInstructions: [], relatedStoryId: null, relatedChallengeId: null, collectionIds: [], tags: [], createdAt: new Date().toISOString() },
]);
